...
- Source publication commit: `4dde806ca28b6ebebc36063228023cd717edcf95` (fast-forward remediation child).
- Source publication tree: `b2442b4e2c72d31e7088d34978b418ecb2395214`.
- Evidence follow-up commit: `a899515` (documentation-only update after the source CI run).
...
- CI: [run 35466116217](https://github.com/quangtaiqn/TypeSafe_Plugin/actions/runs/35466116217), conclusion `success` for the source publication commit.
