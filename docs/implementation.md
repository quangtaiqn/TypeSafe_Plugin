...
| R0 | `COMPLETE` | `R0-recovery-ready`, hash validation, isolated restore, secret exclusion. | Local recovery data is intentionally ignored by Git. |
...
| CP4-GH | `PENDING_PUSH` | Remote inventory and local pre-push checks prepared. | Requires final commit/tree push and remote read-back. |
